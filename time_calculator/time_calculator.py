def add_time(start, add, startDay=None):
    ...
    if daysLater > 0:
        ...
        if startDay != None:
            ...
            result = str(endHours) + ':' + str(endMins).zfill(2) + ' ' + endAMPM + ', ' + endDay.capitalize() + ' ' + daysLater
    elif startDay != None:
        endDay = days[startDayNumber]
        result = str(endHours) + ':' + str(endMins).zfill(2) + ' ' + endAMPM + ', ' + endDay.capitalize()

    return result


print(
    add_time('11:30 PM', '12:30', 'monday')
)